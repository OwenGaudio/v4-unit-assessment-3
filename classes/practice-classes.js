...
class Character {
  ...
  getInfo(){
    let string = 'This is a ' + this.type + ' character named '+ this.name
    return string
  }
}
//////////////////PROBLEM 2////////////////////
...
class NPC extends Character {
  ...
  dialogue(){
    let string = this.name + ': ' + this.phrase
    return string
  }
}
/*
...
//CODE HERE
let ralph = NPC("Ralph", "human", "Niceland", "I'm gonna wreck it!")
/*
...
class Player extends Character {
  ...
  defend(ammount){
    if((this.healthLevel - ammount) > 0){
      let object = {
      attackStrength: ammount,
      remainingHealth: (this.healthLevel - ammount),
...
//CODE HERE
let aang = Player('Aang', 'airbender', '100', '100')
let ozai = Player('Ozai', 'firebender', '100', '0')
/*
...
//CODE HERE
let fireSpitter = Hero('Fire Spitter','dragon',5000,5000)
fireSpitter.addSuperPower('spitting fire')
fireSpitter.addSuperPower('throwing fire')
fireSpitter.addSuperPower('put out fire')